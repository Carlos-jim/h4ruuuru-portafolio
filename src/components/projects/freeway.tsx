...
export default function FreewayAirlines() {
  return (
    <motion.div
    ...
    >
      ...
      <motion.div className="space-y-6" variants={itemVariants}>
        ...
        <motion.p className="text-gray-300 text-lg" variants={itemVariants}>
          Sistema de reservas de vuelos para la ayuda en la gestion de lo vuelos reservados y para realizar las reservas
        </motion.p>
        ...
        <motion.div className="space-y-4" variants={itemVariants}>
          ...
          <div className="flex flex-wrap gap-3">
            {["ReactJS", "JavaScript", "NodeJS", "ExpressJS", "MySQL", "Framer Motion", "Tailwind CSS"].map(
              (tech) => (
                <motion.span
                  key={tech}
        ...
        <motion.div className="flex gap-4 pt-4" variants={itemVariants}>
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link href="https://github.com/Carlos-jim/freeway" target="_blank">
              <Button
                variant="outline"
